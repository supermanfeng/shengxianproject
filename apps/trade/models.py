...
# 根据get_user_model函数得到我们自己定义的用户模型
# 点进去看一下该函数就会发现是我们在settings中配置的userprofile
User = get_user_model()
...
class OrderInfo(models.Model):
    ...
    user = models.ForeignKey(User, verbose_name='用户')
    order_sn = models.CharField(max_length=20, verbose_name='订单号', null=True, blank=True, unique=True)
    trade_no = models.CharField(max_length=100, verbose_name='交易号', unique=True, null=True, blank=True)
